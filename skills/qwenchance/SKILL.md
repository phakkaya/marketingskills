...
**Retry cap:** never run the same failing command a 3rd time. Can't get something working after ~3 attempts — *even varied ones* — STOP and ask the user; don't grind through more variations.
