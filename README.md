...
| [web-scraping](skills/web-scraping/) | This skill activates for web scraping and Actor development. It proactively discovers APIs via traffic interception,... |
<!-- SKILLS:END -->
...
### Data & Research
- `web-scraping` - Web scraping, API discovery, and Apify Actor development
